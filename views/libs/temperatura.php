  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-md-11 col-cot">
        ...
        <form action="<?php echo constant('URL'); ?>home/vagon" method="post">
          <div class="row mt-3">
            <div class="col-md-8 cont-car">
              ...
              <div class="row">
                ...
                <div class="col-md-8 my-auto">
                  <h3><span class="dblue"> <?php echo $_SESSION['vehiculo']['name']; ?>:</span> <span class="detalles-cot">lorem,lorem,lorem,lorem,lorem</span></h3>
                  <select class="form-select select-flota form-select-sm" id="select-flota" aria-label="Default select example" name="temp">
                    <option selected disabled>Seleccionar Temperatura</option>

                    <?php foreach ($this->temperaturas['valores'] as $val) : ?>
