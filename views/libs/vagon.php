      ...
      <div class="col-md-11 col-cot">
        <div class="row justify-content-between">
          <div class="col-md-4">
            ...
            <p>
              <small>Seleccione el <strong>Tipo de Vagon</strong>
              </small>
            </p>
          </div>
          <div class="col-md-7">
        ...
        <form action="<?php echo constant('URL'); ?>home/tamano" method="post">
          <div class="row mt-3">
            <div class="col-md-8 cont-car">
              ...
              <div class="row">
                ...
                <div class="col-md-8 my-auto">
                  ...
                  <select class="form-select select-flota form-select-sm" id="select-flota" aria-label="Default select example" name="vagontip">
                    <option selected disabled>Tipo de Vagon</option>

                    <?php foreach ($this->vagontip['valores'] as $val) : ?>
